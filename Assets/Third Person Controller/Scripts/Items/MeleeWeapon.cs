...
namespace Opsive.ThirdPersonController
{
    ...
    public class MeleeWeapon : Weapon, IHitboxItem
    {
        ...
        public override void SetActive(bool active, int count)
        {
            base.SetActive(active, count);

            for (int i = 0; i < m_AttackHitboxes.Length; ++i) {
                m_AttackHitboxes[i].SetActive(active);
            }
        }
        ...
        protected override void OnCollisionEnter(Collision collision)
        {
            ...
            if (m_InUse) {
                ...
                // The weapon is not attacking so let the base class handle the collision.
