...
namespace Opsive.ThirdPersonController
{
    ...
    public class CharacterBuilder : MonoBehaviour
    {
        ...
        private static void BuildStandardComponents(Transform[] feet)
        {
            ...
            controller.GroundedIdleFrictionMaterial = controller.GroundedMovingFrictionMaterial = m_MaxFrictionMaterial;
            controller.StepFrictionMaterial = controller.SlopeFrictionMaterial = controller.AirFrictionMaterial = m_FrictionlessMaterial;
